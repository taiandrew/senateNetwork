...
# Runs ERGM regressions on network data
# Data generated by Python earlier steps
# I define a function that I call in a loop for each congress:
  # Reads the data, re-arranges for network / ergm package to use
  # Estimates the ERGM
  # Stores the estimates/coefficients
